...
**Source release/branch:** [v0.4.1](https://github.com/ianepreston/devcontainers/tree/v0.4.1/src/iac)
...
**Digest:** sha256:38fbf1ce3a351d0b374a9502792f86a6457eec41858bbdb393307c606e001e62

**Tags:**
```
docker.io/ianepreston/iac-devcontainer:0.3.1-jammy
docker.io/ianepreston/iac-devcontainer:0.3.1-ubuntu-22.04
docker.io/ianepreston/iac-devcontainer:0.3.1-ubuntu22.04
docker.io/ianepreston/iac-devcontainer:0.3.1-ubuntu
```
...
**Digest:** sha256:d6036c83e584016b2a49d44da80bfd631e129fd1360dbd62fd1c342ffdde54e6

**Tags:**
```
docker.io/ianepreston/iac-devcontainer:0.3.1-focal
docker.io/ianepreston/iac-devcontainer:0.3.1-ubuntu-20.04
docker.io/ianepreston/iac-devcontainer:0.3.1-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
