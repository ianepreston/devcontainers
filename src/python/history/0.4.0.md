...
**Source release/branch:** [v0.4.3](https://github.com/ianepreston/devcontainers/tree/v0.4.3/src/python)
...
**Digest:** sha256:69b2bb148ed684365d3ade714a48375be83d50d89b3b1fceffe1e744eea5a811

**Tags:**
```
docker.io/ianepreston/python-devcontainer:0.4.0-jammy
docker.io/ianepreston/python-devcontainer:0.4.0-ubuntu-22.04
docker.io/ianepreston/python-devcontainer:0.4.0-ubuntu22.04
docker.io/ianepreston/python-devcontainer:0.4.0-ubuntu
```
...
**Digest:** sha256:8d14acbc9e6eb7fba32211c10d8017276cbaebc7b804f149d18bd1e2f260d433

**Tags:**
```
docker.io/ianepreston/python-devcontainer:0.4.0-focal
docker.io/ianepreston/python-devcontainer:0.4.0-ubuntu-20.04
docker.io/ianepreston/python-devcontainer:0.4.0-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
