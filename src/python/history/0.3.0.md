...
**Source release/branch:** [v0.4.1](https://github.com/ianepreston/devcontainers/tree/v0.4.1/src/python)
...
**Digest:** sha256:33315d151268af0d06b0ffd079ab90a66a683f04afaf54c0eafbb41ab024f141

**Tags:**
```
docker.io/ianepreston/python-devcontainer:0.3.0-jammy
docker.io/ianepreston/python-devcontainer:0.3.0-ubuntu-22.04
docker.io/ianepreston/python-devcontainer:0.3.0-ubuntu22.04
docker.io/ianepreston/python-devcontainer:0.3.0-ubuntu
```
...
**Digest:** sha256:52a372e53d3d5ae86df825e2eb8507897022bc4d95e29a312739b7f7da631948

**Tags:**
```
docker.io/ianepreston/python-devcontainer:0.3.0-focal
docker.io/ianepreston/python-devcontainer:0.3.0-ubuntu-20.04
docker.io/ianepreston/python-devcontainer:0.3.0-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
