...
**Source release/branch:** [v0.2.32](https://github.com/ianepreston/devcontainers/tree/v0.2.32/src/base-ubuntu)
...
**Digest:** sha256:815b0e6b92546693a3d0422764226fe160e822e39e3fa8e09b515983b185b42a

**Tags:**
```
docker.io/ianepreston/base-devcontainer:2.1.0-jammy
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu-22.04
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu22.04
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu
```
...
**Digest:** sha256:474de135001b20010f6774792cb974bb6cce90c7c22196b8294141cf38727138

**Tags:**
```
docker.io/ianepreston/base-devcontainer:2.1.0-focal
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu-20.04
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:fe7af54388c553b95c1aa858c87f7ea4f57dd797be175bfae656ecce9dd83954

**Tags:**
```
docker.io/ianepreston/base-devcontainer:2.1.0-bionic
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu-18.04
docker.io/ianepreston/base-devcontainer:2.1.0-ubuntu18.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
