...
**Source release/branch:** [v0.2.31](https://github.com/ianepreston/devcontainers/tree/v0.2.31/src/base-ubuntu)
...
**Digest:** sha256:4bc22e097dafaa9f9bf352c06babbf21bed79e662459d474fd421c67d81a1278

**Tags:**
```
docker.io/ianepreston/base-devcontainer:2.0.0-jammy
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu-22.04
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu22.04
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu
```
...
**Digest:** sha256:4650e99c9debea6a0b4519d96b0664ba70abfafb397ec3eddb3e6cb727a90bab

**Tags:**
```
docker.io/ianepreston/base-devcontainer:2.0.0-focal
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu-20.04
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:6c4f82ab9acf2c5629ddcbd53583a270a462b834c61b76638cf05cf37efc5056

**Tags:**
```
docker.io/ianepreston/base-devcontainer:2.0.0-bionic
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu-18.04
docker.io/ianepreston/base-devcontainer:2.0.0-ubuntu18.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
