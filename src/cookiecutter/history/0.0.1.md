...
**Source release/branch:** [v0.4.1](https://github.com/ianepreston/devcontainers/tree/v0.4.1/src/cookiecutter)
...
**Digest:** sha256:987f3f076fc27834834e7363c289eba42a54888c92da690c364e6aa2ccd15dfe

**Tags:**
```
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-jammy
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-ubuntu-22.04
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-ubuntu22.04
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-ubuntu
```
...
**Digest:** sha256:f5714fab305883c4b4afbc987f96cd4ee52e2658a7ee0cf365aff71cbafd86b9

**Tags:**
```
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-focal
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-ubuntu-20.04
docker.io/ianepreston/cookiecutter-devcontainer:0.0.1-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
